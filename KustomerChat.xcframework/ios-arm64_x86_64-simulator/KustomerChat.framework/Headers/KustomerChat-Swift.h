...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KustomerChat",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// :nodoc:
SWIFT_CLASS("_TtC12KustomerChat12ConfettiView")
...
SWIFT_CLASS("_TtC12KustomerChat15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(KustomerChat)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(KustomerChat)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(KustomerChat)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(KustomerChat)) <NSURLSessionTaskDelegate>
