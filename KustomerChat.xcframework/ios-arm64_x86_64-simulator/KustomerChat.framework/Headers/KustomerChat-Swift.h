...
@interface SupportTabViewController : UITabBarController
...
/// Handles tab bar item selection and updates indicator views.
/// On iOS 26.0+, hides custom indicators as the native tab bar provides selection indicators.
